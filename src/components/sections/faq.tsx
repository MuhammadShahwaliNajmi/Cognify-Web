...
const FAQS = [
  ...
  },
  {
    ...
    a: "One hour of live, co-taught class a day, five days a week, in a small cohort — Microeconomics and Macroeconomics each led by a specialist. Around that sit compulsory weekly assignments and a monthly assessment with live exam feedback from trained examiners, so you're always being measured against the real standard.",
  },
  {
